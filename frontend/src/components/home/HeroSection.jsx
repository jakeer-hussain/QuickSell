    ...
    <div className="clay-card p-6 md:p-10 bg-gradient-to-br from-indigo-50/50 via-pink-50/30 to-purple-50/40 border border-white relative overflow-hidden">
      <div className="relative z-10 max-w-2xl space-y-4">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-slate-800 leading-tight">
          Your Marketplace for Buying and Selling{" "}
        ...
        <p className="text-slate-600 text-sm md:text-base font-medium leading-relaxed">
          List products, explore thousands of items, communicate with sellers, and
          make informed decisions through product inquiries. ReSeller makes second-hand
          trading simple, transparent, and convenient.
        </p>
      </div>
